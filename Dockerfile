...
#RUN echo "oracle-java11-installer shared/accepted-oracle-license-v1-1 boolean true" | debconf-set-selections
...
CMD ["java", "-cp", "/usr/local/docker-git-hello-world/target/docker-git-1.0-SNAPSHOT.jar", "com.cherepakha.HelloWorldPing"]